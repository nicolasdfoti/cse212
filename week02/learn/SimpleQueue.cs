public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: It tried to remove items from index one, not zero.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: It tried to add the items in the front, not the back.
        ...
        // Defect(s) Found: None! Everything good.
    }
